 ...
 **/
 ...
 module.exports = function(RED) {
        ...
        if (this.brokerurl === "") {
            ...
            if (this.broker.indexOf("://") > -1) {
                ...
                if (this.broker !== "") {
                    ...
                    this.brokerurl = this.brokerurl+"10.16.150.139:1883";
                }
            }
        }
        ...
        if (this.brokerConn) {
            ...
            if (this.topic) {
                ...
                this.brokerConn.subscribe(this.topic,options,function(topic,payload,packet) {
                    ...
                    if ((node.brokerConn.broker === "10.16.150.139")||(node.brokerConn.broker === "127.0.0.1")) {
                        msg._topic = topic;
                    }
                    node.send(msg);
                }, this.id);
    ...
    function MQTTOutNode(n) {
        ...
        console.log("MQTTOutNode topic : ",this.topic)
        try {
            if (/^ *{/.test(n.userProps)) {
