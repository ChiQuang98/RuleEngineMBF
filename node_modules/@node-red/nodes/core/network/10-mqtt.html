...
<script type="text/html" data-template-name="mqtt in">
    <div class="form-row">
        <label for="node-input-broker"><span class="fa fa-globe">Server & Topic</span> </label>
        <input type="text" id="node-input-broker">
    </div>
<!--    <div class="form-row">-->
<!--        <label for="node-input-topic"><i class="fa fa-tasks"></i> <span data-i18n="common.label.topic"></span></label>-->

<!--        &lt;!&ndash; <input type="text" id="node-input-topic" data-i18n="[placeholder]common.label.topic"> &ndash;&gt;-->
<!--        <select name="cars" id="node-input-topic">-->
<!--            &lt;!&ndash;            <option value="h2/s/#"> h2/s/#</option>&ndash;&gt;-->
<!--        </select>-->
<!--    </div>-->
    <div class="form-row">
    ...
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span id="quangid" data-i18n="common.label.name"></span></label>
...
<script type="text/html" data-template-name="mqtt out">
    <div class="form-row">
        <label for="node-input-broker"><i class="fa fa-globe"></i> <span data-i18n="mqtt.label.broker">Server & Topic</span></label>
        <input type="text" id="node-input-broker">
    </div>
<!--    <div class="form-row">-->
<!--        <label for="node-input-topic"><i class="fa fa-tasks"></i> <span data-i18n="common.label.topic"></span></label>-->
...
<script type="text/html" data-template-name="mqtt-broker">
    ...
    <div id="node-config-mqtt-broker-tabs-content" style="min-height:150px;">
        ...
        <div id="mqtt-broker-tab-security">
            <div class="form-row">
                <label for="node-config-input-topic"><i class="fa fa-tasks"></i> <span data-i18n="common.label.topic"></span></label>

                <!-- <input type="text" id="node-input-topic" data-i18n="[placeholder]common.label.topic"> -->
                <select name="cars" id="node-config-input-topic">
        ...
        var loadData = function () {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var listChannel = response.data
                    for (var i = 0; i < listChannel.length; i++) {
                        var select = document.getElementById("node-config-input-topic");
                        for (var i = 0; i < listChannel.length; i++) {
                            var el = document.createElement("option");
                            el.textContent = listChannel[i].channel_name;
                            el.value = "channels/" + listChannel[i].channel_id + "/messages";
                        ...
                        // document.getElementById("node-input-name").value = "Mobifone Channel In";
                        var a = document.getElementById('node-config-input-topic');
                        $('#node-config-input-topic').change(function () {
                            // alert(this.value);
                            // console.log(a.selectedIndex);
                            var username = listChannel[a.selectedIndex].thing_id;
                            var password = listChannel[a.selectedIndex].thing_key;
                            $('#node-config-input-user').val(username);
                            $('#node-config-input-password').val(password);
                        });
                        $('#node-config-input-topic').trigger('change');
                    }
                },
                error: function(xhr, status, err) {
                    console.log(xhr.responseText);
...
<script type="text/javascript">
    (function () {
        ...
        RED.nodes.registerType('mqtt in', {
            ...
            oneditprepare: function () {
                $('#node-input-name').val('Mobifone Channel In');
