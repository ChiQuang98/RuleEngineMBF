...
var ensureRuntimeStarted = function(req,res,next) {
    ...
    runtimeAPI.isStarted().then( started => {
        if (!started) {
            ...
            if(req.session){
                console.log(settingConfig.getHostNodered()+':'+settingConfig.getPortNodered()+settingConfig.getUrlCheckToken())
                ...
                if (typeof token !== 'undefined'){
                    ...
                    const options = {
                        ...
                        path: settingConfig.getUrlCheckToken(),
                        method: 'GET',
                        headers: {
                            Authorization: `${token}`
                        }
                    ...
                    callback = function(response) {
                        ...
                        response.on('end', function () {
                            ...
                            if (response.statusCode == 200) {
                                ...
                                res.status(405).send("Không thể xác thực!!!")
                            }
                        });
                    }
                    ...
                    // fs.createReadStream('401unauthen.html').pipe(res);
                    res.status(401).send("Bạn chưa đăng nhập!!!")
                }

            }
            else {
                console.log("Session khong ton tai")
                res.status(401).send("Bạn chưa đăng nhập!!!")
            }
        }
    })
...
module.exports = {
    init: function(server, settings, _runtimeAPI) {
        ...
        if (!settings.disableEditor) {
            ...
            editorApp.use("/projects",projects.app());0
