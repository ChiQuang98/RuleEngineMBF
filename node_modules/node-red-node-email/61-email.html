<script type="text/html" data-template-name="e-mail">
    <div class="form-row">
        ...
        <input type="text" id="node-input-name" placeholder="host@address.com|comma for multiple emails">
    </div>
    <!-- <div class="form-row">
    ...
    <div class="form-row">
        ...
        <input type="text" id="node-input-server" placeholder="email server" value="10.3.12.25">
    </div>
    <div class="form-row">
        <label for="node-input-port"><i class="fa fa-random"></i> <span data-i18n="email.label.port"></span></label>
        <input type="text" id="node-input-port" placeholder="465" style="width:100px" value="25">
        <label style="width:40px"> </label>
        <input type="checkbox" id="node-input-secure" style="display:inline-block; width:20px; vertical-align:baseline;" checked="">
...
(function() {
    RED.nodes.registerType('e-mail',{
        ...
        color:"#c7e9c0",
        defaults: {
            server: {value:"10.3.12.25",required:true},
