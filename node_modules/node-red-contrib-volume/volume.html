...
<script type="text/javascript">
  ...
  const isValidTime = function (time) {
    ...
    RED.nodes.registerType('anomaly volume TTTM', {
        ...
        label: function() {
            return this.name||"anomaly volume TTTM";
        },
    });
</script>

<script type="text/html" data-template-name="anomaly volume TTTM">
    <div class="form-row">
...
<script type="text/html" data-help-name="anomaly volume TTTM">
